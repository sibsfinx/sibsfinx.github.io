...
Subpage H1 uses gray `alexmesch.com` crumb + `&nbsp;&nbsp;` + title (see `.ai/rules/BASE.md`). Homepage right-column `social-link--grid`: **About** and **Work** first, then GitHub / LinkedIn / other profiles (no Home, no Email in the top link column).
